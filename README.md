...
1.  **Create a Gatsby site.**
    ...
    Use the Gatsby CLI to create a new site, specifying the rsshub starter.

    ```shell
    # create a new Gatsby site using the rsshub starter
    gatsby new gatsby-rsshub https://github.com/theowenyoung/gatsby-starter-rsshub.git
    ```
